        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" id="department">
                ...
                <select name="department" id="department" class="form-control">
                    ...
                    <option value="About" <?php if ($singlepage['pg_category'] == 'About') {
            echo "Selected";
        } ?>>About</option>
                    <option value="Diagnostic" <?php if ($singlepage['pg_category'] == 'Diagnostic') {
            echo "Selected";
        } ?>>Diagnostic</option> 
                    <option value="Centre of Excellence" <?php if ($singlepage['pg_category'] == 'Centre of Excellence') {
            echo "Selected";
        } ?>>Centre of Excellence</optio>
                    <option value="Patient Query" <?php if ($singlepage['pg_category'] == 'Patient Query') {
            echo "Selected";
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" rows="15" class="form-control"  placeholder="content"><?php echo $singlepage['pg_description']; ?></textarea>
