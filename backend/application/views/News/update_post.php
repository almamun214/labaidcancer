    ...
    <div class="card-body">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" value="<?php echo $post['bl_title']; ?>" placeholder="New News">
            ...
            <div class="form-group" id="department">
                ...
                <select name="department" id="department" class="form-control">
                    ...
                    <?php foreach ($department as $dpt):
                        ...
                        if ($post['bl_category'] == $dpt->bc_id) {
                            ?>
                            <option value="<?php echo $dpt->bc_id; ?>" selected="1"><?php echo $dpt->bc_title; ?></option>
                        <?php } else { ?>
...
<?php endforeach; ?>
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" rows="10" class="form-control"  placeholder="content"><?php echo $post['bl_content']; ?></textarea>
                <small  class="warning"><?php echo form_error('content'); ?></small>      
            </div>
            
            <div class="form-group">
                <label for="keyword">SEO Keyword </label>
                <input type="text" class="form-control" id="keyword" name="keyword" value="<?php echo $post['bl_keyword']; ?>" placeholder="keyword1,keyword">
                <small  class="warning"><?php echo form_error('keyword'); ?></small>   
            </div>
            
            <div class="form-group">
                <label for="metadata">SEO Meta Description </label>
                <input type="text" class="form-control" id="metadata" name="metadata" value="<?php echo $post['bl_meta']; ?>" placeholder="description" max_length="160">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="<?php echo base_url($post['bl_featured_image']); ?>" style="height:100px;">
                    <input type="hidden" name="oldimg" value="<?php echo $post['bl_featured_image']; ?>">
                </div>
            </div>
