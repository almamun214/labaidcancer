...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>LabAid Cancer</b>HOSPITAL</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in to start your session</p>
      <p class="login-box-msg" style="color:red;"><?php echo $this->session->flashdata('msg'); ?></p>
...
<!-- Bootstrap 4 -->
<script src="<?php echo base_url(); ?>asset/admin/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
