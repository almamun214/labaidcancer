...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="driver_name" name="qname" value="<?php echo $gq['swo_name']; ?>" placeholder="Name">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <img src="<?php echo base_url().$gq['swo_image']; ?>" width="50">
                <input type="hidden" name="oldimg" value="<?php echo $gq['swo_image']; ?>">
