    ...
    <script>
        ...
        function addSection() {
            ...
            if (Altext == "") {
                $.ajax({
                    ...
                    url: "<?php echo base_url('packages/add_patientTabdata'); ?>",
                    dataType: 'json',
        ...
        function displayData() {
            ...
            $.ajax({
                type: 'POST',
                data: {cnid: cnid},
                url: "<?php echo base_url('packages/display_patientJsonData'); ?>",
                dataType: 'json',
                success: function (response) {
                    var count = 1;
                    $.each(response, function (index, value) {

                        content += "<tr><td>" + value.pqp_name + "</td><td><button class='btn btn-danger' onclick='removeData(" + value.pqp_id + ")' title='Remove'>X</button> </td></tr>";
                    });
        ...
        function removeData(id) {
            ...
            $.ajax({
                type: 'POST',
                data: {id: id},
                url: "<?php echo base_url('packages/remove_patientPackageTab'); ?>",
                dataType: 'json',
                success: function (response) {
                    displayData();
                }
