...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" value="<?php echo set_value('designation'); ?>" class="form-control" name="designation">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" value="<?php echo set_value('order'); ?>" class="form-control" name="order">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea name="content" class="form-control" rows="5" placeholder="desctiption"></textarea>
