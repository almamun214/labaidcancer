            ...
            <table class="table table-bordered" id="dbtable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $key->ab_title; ?></td>
                        <td><?php echo substr(strip_tags($key->ab_description), 0, 100); ?></td>
                        
                        
                        <td>
                            <a href="<?php echo base_url('menucontrol/update_pagecontent/'.$key->ab_id); ?>" class="btn btn-info">E</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
