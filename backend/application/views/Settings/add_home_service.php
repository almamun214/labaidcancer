...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="hs_icon" name="hs_icon" value="<?php set_value('hs_icon'); ?>" placeholder="fa fa-address-card">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="hs_name" name="hs_name" value="<?php set_value('hs_name'); ?>" placeholder="24/7 Service">
