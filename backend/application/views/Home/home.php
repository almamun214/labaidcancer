    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo base_url(); ?>asset/frontend/images/slider/slider1.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1 class="display-6 animate__animated animate__fadeInUp">Leading the fight</h1>
...
<section id="why-patient-choose" style="background: url(<?php echo base_url();?>/asset/frontend/images/hospital.png);  top: -300px;
    background-repeat: no-repeat;
    background-position: right; margin-top: 199px; background-size: 95%;">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <br>
                ...
                <br>
                <br>
                <div class="text-left" style="padding-bottom: 60px; margin-top: -20%;">
                    <h4 class="title1">Why patient choose</h4>
                    <h2 class="title2">Labaid Cancer Hospital & Super Speciality Centre</h2>
                    <br>
                    <br>
                    <p class="pe-5 d-none d-md-block">Labaid Cancer Hospital and Super Speciality Center, a
                ...
                <div class="row service-cards">
                    ...
                    <div class=" ">
                        <div class="card service_card p-3 " style="width: 200px;">
                  <span>
        ...
        <div class="container" style="height: 16px;position: relative;top: -249px;">
            <div class="row justify-content-center">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card text-center align-items-center mb-5" style="min-width: 12rem;">
                        <img src="<?php echo base_url($tcno->tec_image); ?>" class="card-img-top rounded-3" alt="..." style="width: 224px; height: 306px; object-fit: cover;">
                        <div class="card-body rounded-3 shadow"  >
                            <h6 class="card-title p-2"><?php echo $tcno->tec_name; ?></h6>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-5" style="padding: 0 34px;">
                <div class="card rounded-3">
                    <q class="customer-review"><?php echo $tmonial->pt_message; ?></q>
                    <hr>
                    <div class="row">
                        <div class="col-md-3"><img src="<?php echo base_url($tmonial->pt_image); ?>" class="rounded-circle" alt="<?php echo $tmonial->pt_name; ?>" style="width: 3.494rem;"></div>
                        <div class="col-md-9">
                            <div><h4><?php echo $tmonial->pt_name; ?></h4></div>
