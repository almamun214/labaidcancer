            ...
            foreach ($gqlist as $tablink):
                ...
                <div class="col-sm-3">
                    <div class="card text-center">
                        <a href="<?php echo base_url('package-details/'.$tablink->dpm_id); ?>">
                            <img class="card-img-top" src="<?php echo base_url($tablink->dpm_image); ?>" alt="" style="max-width: 300px;">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $tablink->dpm_name; ?></h5>
                            </div>
                        </a>
                    </div>
                </div>
