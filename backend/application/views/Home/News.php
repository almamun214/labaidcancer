                ...
                <div class="d-flex">
                    ...
                    <a href="<?php echo base_url('blog-post/1st-anniversary-celebration-2022'); ?>">
                        <div class="article " style="margin-right: 8px;">
                            ...
                            <div class="article-content">
                                <h5 class="article-title article-card-small">1st Anniversary Celebration of LabAid Cancer Hospital & Super Specialty Center</h5>
                ...
                <div class="d-flex">
                    ...
                    <a href="<?php echo base_url('blog-post/LCH-launches-4-new-centre'); ?>">
                        <div class="article " style="margin-left: 8px;">
                            ...
                            <div class="article-content">
                                <h5 class="article-title article-card-small">World Pharmacist Day</h5>
                                <button type="button" class="article-date">Dec 2021</button>
                            </div>
                        </div>
                    </a>
        ...
        <div class="row mt-3">
            ...
            <a href="<?php echo base_url('blog-post/LCH-launches-4-new-centre'); ?>">
                <div class="article ">
                    ...
                    <div class="article-content">
                        <h5 class="article-title article-card-medium">Patient Family Advisory Council Program</h5>
                ...
                <div class="d-flex">
                    ...
                    <a href="<?php echo base_url('blog-post/LCH-launches-4-new-centre'); ?>">
                        <div class="article " style="margin-right: 8px;">
                            ...
                            <div class="article-content">
                                <h5 class="article-title article-card-small">International Breast Cancer Day</h5>
                                <button type="button" class="article-date">Dec 2021</button>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="<?php echo base_url('blog-post/LCH-launches-4-new-centre'); ?>">
                        <div class="article " style="margin-left: 8px;">
                            ...
                            <div class="article-content">
                                <h5 class="article-title article-card-small">World Lung Cancer Awareness Month</h5>
                                <button type="button" class="article-date">Dec 2021</button>
                            </div>
                        </div>
                    </a>
            ...
            <a href="<?php echo base_url('blog-post/LCH-launches-4-new-centre'); ?>">
                <div class="article">
                    ...
                    <div class="article-content">
                        <h5 class="article-title">Distribution of food to the helpless and distressed in remembrance of all the martyrs of Bangladesh on the 50th anniversary of victory</h5>
        ...
        <div class="row mt-3">
            ...
            <a href="<?php echo base_url('blog-post/Health-Check-up-Camp-Diabetes-Awareness-Session'); ?>">
                <div class="article">
                    ...
                    <div class="article-content">
                        <h5 class="article-title">Health Check-up Camp and Diabetes Awareness Session</h5>
            ...
            <a href="<?php echo base_url('blog-post/LCH-launches-4-new-centre'); ?>">
                <div class="article ">
                    ...
                    <div class="article-content">
                        <h5 class="article-title article-card-medium">Inauguration of state-of-the-art breast cancer diagnosis machine at Labaid</h5>
                ...
                <!-- <div class="d-flex">
                  <div class="col-6 mt-3">
                    <div class="article " style="margin-right: 8px;">
                      <div class="overlay-effect"></div>
                      <img src="./images/news-article/27 1.png" class="img-fluid" alt="">
                      <div class="article-content">
                        <h5 class="article-title article-card-small">Patient Family Advisory Council Program</h5>
                      <button type="button" class="article-date">Dec 2021</button>
                      </div>
                  ...
                  <div class="col-6 mt-3">
                    <div class="article " style="margin-left: 8px;">
                      <div class="overlay-effect"></div>
                      <img src="./images/news-article/28 1.png" class="img-fluid" alt="">
                      <div class="article-content">
                        <h5 class="article-title article-card-small">World Pharmacist Day</h5>
                      <button type="button" class="article-date">Dec 2021</button>
                      </div>
