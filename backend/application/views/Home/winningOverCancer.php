...
<section id="winning-cancer" class="container">
    <div class="row">
        ...
        <div class="col-md-6 right-content">
            <h5 class="title1 display-4">Winning</h5>
    ...
    <div class="row" style="padding-top: 150px;">
        <div class="col-md-6 right-content">
            <h5 class="title1 display-4">Understanding</h5>
            <h1 class="title2 display-4">Cancer</h1>
            <br>
            <div style="text-align: justify;">
                <p>
    ...
    <div class="row" style="padding-top: 150px;">
        ...
        <div class="col-md-6 right-content">
            <h5 class="title1 display-4">Early</h5>
            <h1 class="title2 display-4">Diagnosis</h1>
            <br>
            <div style="text-align: justify;">
                <p>
