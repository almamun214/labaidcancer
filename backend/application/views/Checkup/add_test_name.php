...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="testname" name="testname" value="<?php set_value('testname'); ?>" placeholder="Test Name">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="description" name="description" value="<?php set_value('description'); ?>" placeholder="Short Name">
...
<!--            <label class="col-sm-2 col-form-label">Test Price</label>-->
            <div class="col-sm-10">
                <input type="hidden" class="form-control" id="testprice" name="testprice" value="<?php set_value('testprice'); ?>" step="0.5" placeholder="500.0">
