    ...
    <div class="card-body">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" value="<?php echo $post['dpt_name']; ?>" placeholder="Name">
                <small  class="warning"><?php echo form_error('title'); ?></small>   
            </div>

            <div class="form-group">
                <label for="content">Content <span class="required">*</span></label>
                <textarea name="content" id="content" rows="10" class="form-control"  placeholder="content"><?php echo $post['dpt_description']; ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="<?php echo base_url($post['dpt_image']); ?>" style="height:100px;">
                    <input type="hidden" name="oldimg" value="<?php echo $post['dpt_image']; ?>">
                </div>
            </div>
