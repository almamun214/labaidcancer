...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Comprehensive Care Information</h3>
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="driver_name" name="cc_name" value="<?php set_value('cc_name'); ?>" placeholder="Name">
