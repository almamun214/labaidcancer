...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">New Bed Information</h3>
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control" id="roomname" name="roomname" value="<?php set_value('roomname'); ?>">
                    <option value="">Select Room</option>
                    
                    <?php foreach($room as $rm): ?>
                    <option value="<?php echo $rm->room_id; ?>"><?php echo $rm->room_name; ?></option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" id="description" name="description" row="3" placeholder="Description" value="<?php set_value('description'); ?>"></textarea>
