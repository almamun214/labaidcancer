...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="vehicle_no" name="vehicle_no" value="<?php set_value('vehicle_no'); ?>" placeholder="Vehicle Number">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="driver_name" name="driver_name" value="<?php set_value('driver_name'); ?>" placeholder="Driver Name">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="driver_nid" name="driver_nid" value="<?php set_value('driver_nid'); ?>" placeholder="Driver NID">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="contact_no" name="contact_no" value="<?php set_value('contact_no'); ?>" placeholder="Contact Number">
