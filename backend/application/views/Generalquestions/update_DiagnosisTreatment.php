...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Diagnosis and Treatment Information</h3>
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="driver_name" name="qname" value="<?php echo $gq['gq_title']; ?>" placeholder="Question">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" rows="4" placeholder="description" id="description" name="descripton"><?php echo $gq['gq_description']; ?></textarea>
